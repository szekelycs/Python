                ...
                if row[3] == 'Move':
                    ...
                    if limit < float(row[1]):
                        if rowCntWithoutDuplicates > 4:
                            ...
                            angleVeloDetails = cf.pointSpeedAngleAcceleration(user, fileName, xCoords, yCoords,
                            ...
                            writer.writerow([user, method, fileName, tmpStartLine, allRows, rowCnt, st.mouseMove,
                                             ...
                                             angleVeloDetails[6], angleVeloDetails[7], angleVeloDetails[8],
                                             angleVeloDetails[9], angleVeloDetails[10], angleVeloDetails[11],
                                             angleVeloDetails[12], angleVeloDetails[13], angleVeloDetails[14],
                                             angleVeloDetails[15], angleVeloDetails[16], angleVeloDetails[17],
                                             angleVeloDetails[18], angleVeloDetails[19], angleVeloDetails[20],
                                             angleVeloDetails[21], angleVeloDetails[22],
                                             angleVeloDetails[23]])  # mouse move
                            ...
                            if leftPressed == 1:
                                ...
                                if xCoords and yCoords:
                                    ...
                                    if (rowCntWithoutDuplicates - 2) > 4:
                                        ...
                                        angleInRad = cf.countSumDirection(xCoords[0], yCoords[0], xCoords[-1],
                                                                          yCoords[-1])
                                        tmpMoveFinishTime = None
                                        # angle and speed datas (min, max, avg point by point)
                                        angleVeloDetails = cf.pointSpeedAngleAcceleration(user, fileName, xCoords,
                                                                                          yCoords, timeDatas,
                                    ...
                                    if rightPressed == 1:
                                        ...
                                        if xCoords and yCoords:
                                            ...
                                            if (rowCntWithoutDuplicates - 2) > 4:
                                                ...
                                                time = tmpMoveFinishTime - tmpStartTime;
                                                angleInRad = cf.countSumDirection(xCoords[0], yCoords[0],
                                                                                  xCoords[-1], yCoords[-1])
                                                tmpMoveFinishTime = None
                                                # angle and speed datas (min, max, avg point by point)
                                                # if (len(xCoords) != rowCntWithoutDuplicates):
                                                #     print(user, fileName, len(xCoords), len(yCoords), len(timeDatas), rowCntWithoutDuplicates, tmpStartLine, allRows)
                                                angleVeloDetails = cf.pointSpeedAngleAcceleration(user, fileName,
                                                                                                  xCoords, yCoords,
                                                                                                  timeDatas,
                                                                                                  rowCntWithoutDuplicates)
                                                # append to csv file
                                                writer.writerow(
                                                    [user, method, fileName, tmpStartLine, allRows - 2, rowCnt - 2,
                                                     ...
                                                     angleVeloDetails[5], angleVeloDetails[6], angleVeloDetails[7],
                                                     angleVeloDetails[8], angleVeloDetails[9], angleVeloDetails[10],
                                                     angleVeloDetails[11], angleVeloDetails[12],
                                                     angleVeloDetails[13], angleVeloDetails[14],
                                                     angleVeloDetails[15], angleVeloDetails[16],
                                                     angleVeloDetails[17], angleVeloDetails[18],
                                                     angleVeloDetails[19], angleVeloDetails[20],
                                                     angleVeloDetails[21], angleVeloDetails[22],
                                                     angleVeloDetails[23]])  # mouse move
                                            # empty vectors
                                            del timeDatas[:]
                                    ...
                                    if rowCntWithoutDuplicates > 4:
                                        ...
                                        writer.writerow(
                                            [user, method, fileName, tmpStartLine, allRows, rowCnt, st.rightClick,
                                             ...
                                             angleVeloDetails[18], angleVeloDetails[19], angleVeloDetails[20],
                                             angleVeloDetails[21], angleVeloDetails[22],
                                             angleVeloDetails[23]])  # right click
                                    ...
                                    if leftPressed == 1:
                                        ...
                                        if rowCntWithoutDuplicates > 4:
                                            ...
                                            writer.writerow([user, method, fileName, tmpStartLine, allRows, rowCnt,
                                                             ...
                                                             angleVeloDetails[3], angleVeloDetails[4],
                                                             angleVeloDetails[5], angleVeloDetails[6],
                                                             angleVeloDetails[7], angleVeloDetails[8],
                                                             angleVeloDetails[9], angleVeloDetails[10],
                                                             angleVeloDetails[11], angleVeloDetails[12],
                                                             angleVeloDetails[13], angleVeloDetails[14],
                                                             angleVeloDetails[15], angleVeloDetails[16],
                                                             angleVeloDetails[17], angleVeloDetails[18],
                                                             angleVeloDetails[19], angleVeloDetails[20],
                                                             angleVeloDetails[21], angleVeloDetails[22],
                                                             angleVeloDetails[23]])  # left click
                                        # empty x and y coordinates vectors
                                        del timeDatas[:]
                                        del xCoords[:]
                                        del yCoords[:]
                                        ...
                                        if leftDrag == 1:
                                            ...
                                            if rowCntWithoutDuplicates > 4:
                                                ...
                                                writer.writerow(
                                                    [user, method, fileName, tmpStartLine, allRows, rowCnt,
                                                     ...
                                                     angleVeloDetails[19], angleVeloDetails[20],
                                                     angleVeloDetails[21], angleVeloDetails[22],
                                                     angleVeloDetails[23]])  # left click drag
                                            # empty x and y coordinates vectors
                                            del timeDatas[:]
                                            del xCoords[:]
                                            del yCoords[:]
                                            ...
                                            if rightDrag == 1:
                                                ...
                                                if rowCntWithoutDuplicates > 4:
                                                    ...
                                                    angleInRad = cf.countSumDirection(xCoords[0], yCoords[0],
                                                                                      xCoords[-1], yCoords[-1])
                                                    # angle and speed datas (min, max, avg point by point)
                                                    angleVeloDetails = cf.pointSpeedAngleAcceleration(user,
                                                                                                      fileName,
                                                                                                      xCoords,
                                                                                                      yCoords,
                                                                                                      timeDatas,
                                                    ...
                                                    writer.writerow(
                                                        [user, method, fileName, tmpStartLine, allRows, rowCnt,
                                                         ...
                                                         angleVeloDetails[19], angleVeloDetails[20],
                                                         angleVeloDetails[21], angleVeloDetails[22],
                                                         angleVeloDetails[23]])  # right click drag
                                                # empty x and y coordinates vectors
                                                del timeDatas[:]
                                                del xCoords[:]
                                                del yCoords[:]
                                            ...
                                            # case wrong value in state column ---> error?
                                                ...
                                                print(user, " ", fileName, " ",
                                                      "--- no Press or Drag before Release?, rowCnt: ", rowCnt,
                                                      " ; n-from: ", tmpStartLine, " ; n-to", allRows)
                                                del timeDatas[:]
                                                del xCoords[:]
                                                del yCoords[:]
...
def processCsv(method):
    ...
    if method == 1: #train
        ...
        if method == 0: #test
            ...
            dataset = pd.read_csv(st.publicLabels)
            publicFileNames = dataset.values
        else:
    ...
    with open(opFile, "w+", newline='') as csvOutFile:
        ...
        for dirname, dirnames, filenames in os.walk(ipDir):
            for fileName in filenames:
                ...
                if fileName in publicFileNames:
